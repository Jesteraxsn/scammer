document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(event) {
        ...
        const emailRegex = /^[^\s@]+@wit\.edu$/;
        if (!emailRegex.test(email.value)) {
            document.getElementById('emailError').textContent = 'Please use a valid WIT institutional email';
            isValid = false;
        }
